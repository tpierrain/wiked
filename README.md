...
5. Execute the __`mvn site`__ command-line on your wiked! root pom.xml file in order to generate a classic and static web site (generated in a `(pom.xml directory)/target/site/` directory).
