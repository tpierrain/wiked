...
__wiked! is a well-structured web site generation template to start all your project with.__
--------------------------------------------------------------------------------------------
...
+ __Warning:__ In some cases (like when changing the project name within the pom.xml file), you will have to fully regenerate the web site. In those cases, call __`mvn clean`__ just before the call to __`mvn site`__. 
